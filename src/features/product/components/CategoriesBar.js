...
const CategoriesBar = ({ categories, selectedCategory, handleFilter }) => {
  return (
    <div className="flex overflow-x-auto overflow-y-hidden bg-gradient-to-r justify-center from-blue-500 via-purple-600 to-indigo-600 p-4 sticky top-16 z-40 shadow-lg space-x-2">
